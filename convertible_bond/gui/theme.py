...
TABLE_SELECTED_BG = ("#dce8ff", "#313f5f")
TABLE_SELECTED_TEXT = ("#1e3a8a", "#cdd6f4")
...
#: 上一组是"剥掉 emoji 留文字", 下一组是"独立 emoji 按钮换成纯文本"。
#: **🔄 刻意在上一组**: 它曾是 ``"🔄": "刷新"``, 于是顶栏那个强刷条款的图标按钮在
#: Windows 上渲染成一个孤零零的「刷新」—— 与紧挨着的「📥 同步」并排, 两个等宽中文词
#: 读起来像重复的功能 (用户实测反馈), 而"刷新"又没说刷新的是**什么**。宾语现在写进
#: 按钮自己的文案 (``wind_sync.REFRESH_TERMS_LABEL``), 这里只负责剥 emoji。
_WIN_EMOJI_FALLBACK = {
    "📦 ": "", "⚡ ": "", "📈 ": "", "🎯 ": "", "🔥 ": "",
    "🌐 ": "", "📥 ": "", "🆕 ": "", "⭐ ": "", "📝 ": "",
    "✅ ": "", "❌ ": "", "⚠ ": "", "🔄 ": "", "🗑 ": "",
