...
当前版本是 **2.0.0rc2 候选版**（tag：`v2.0.0-rc.2`），包含 RC1 发布检查发现的 Windows 兼容性修复。这一版把关注池、历史策略研究和桌面交付连成完整工作流。升级涉及 API、CLI、CSV 和模型口径变化，请先读 [版本说明](CHANGELOG.md) 与 [v1 → v2 升级指南](docs/UPGRADING_V2.md)。
